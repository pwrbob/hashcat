...
const char *module_comment (MAYBE_UNUSED const hashconfig_t *hashconfig, MAYBE_UNUSED const user_options_t *user_options, MAYBE_UNUSED const user_options_extra_t *user_options_extra)
{
...
void module_init (module_ctx_t *module_ctx)
{
  ...
  module_ctx->module_comment                  = module_comment;
