...
const char *module_notice_warning (MAYBE_UNUSED const hashconfig_t *hashconfig, MAYBE_UNUSED const user_options_t *user_options, MAYBE_UNUSED const user_options_extra_t *user_options_extra)
{
  return "Some byte encoding is simplified in the optimized kernel for NTLM that would make some non-ASCII passwords never be cracked, even if they are under the optimized byte limit.";
}
...
void module_init (module_ctx_t *module_ctx)
{
  ...
  module_ctx->module_notice_warning           = module_notice_warning;
